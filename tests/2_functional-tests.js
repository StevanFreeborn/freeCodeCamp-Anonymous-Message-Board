    ...
    chai
      ...
      .end((err, res) => {
        ...
        assert.property(
          res.body,
          'name',
          'response does not have name property'
        );
        assert.property(
          res.body,
          'created_on',
          'response does not have created_on property'
        );
        assert.property(
          res.body,
          'bumped_on',
          'response does not have bumped_on property'
        );
        done();
      });
  });
    ...
    chai
      ...
      .end((err, res) => {
        ...
        assert.property(
          res.body,
          'board',
          'response does not have board property'
        );
        assert.property(res.body, '_id', 'response does not have _id property');
        assert.property(
          res.body,
          'text',
          'response does not have text property'
        );
        assert.property(
          res.body,
          'created_on',
        ...
        assert.equal(
          res.body.created_on,
          res.body.bumped_on,
          'responses bumped_on and created_on property are not the same'
        );
        assert.property(
          res.body,
          'replies',
          'response does not have replies property'
        );
        done();
      });
  });
        ...
        chai
          ...
          .end((err, res) => {
            ...
            assert.property(
              res.body,
              'thread',
              'response does not have thread property'
            );
            assert.property(
              res.body,
              '_id',
              'response does not have _id property'
            );
            assert.property(
              res.body,
              'text',
      ...
      .end((err, res) => {
        ...
        threads.forEach(thread => {
          ...
          assert.property(
            thread,
            'created_on',
            'thread does not have created_on property'
          );
          assert.property(
            thread,
            'bumped_on',
            'thread does not have bumped_on property'
          );
          assert.property(
            thread,
            'replies',
    ...
    chai
      ...
      .end((err, res) => {
        ...
        assert.equal(
          res.text,
          'reported',
          'response does not contain the text reported'
        );
        done();
      });
  });
    ...
    chai
      ...
      .end((err, res) => {
        ...
        assert.equal(
          res.text,
          'incorrect password',
          'response does not contain incorrect password text'
        );
        done();
      });
  });
    ...
    chai
      ...
      .end((err, res) => {
        ...
        assert.equal(
          res.text,
          'success',
          'response does not contain text success'
        );
        done();
      });
  });
