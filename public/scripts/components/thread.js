...
export default function createThread(board, thread) {
  ...
  const reportButton = threadComponent.querySelector('.thread-report-button');
  const deleteButton = threadComponent.querySelector('.thread-delete-button');
  ...
  deleteButton.addEventListener('click', e => {
    createDeleteThreadModal(board, thread).toggle(e.relatedTarget)
  });
