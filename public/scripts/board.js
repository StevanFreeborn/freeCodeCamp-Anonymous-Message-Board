...
$(async () => {
  ...
  $('.thread-delete-button').click(e => {
    alert('need to implement deleting thread')
  })
              ...
              <div class="card ${thread.reported ? 'bg-warning' : 'bg-success'} text-white">
                ...
                <div class="card-footer d-flex justify-content-between align-items-center">
                  ...
                  <div id="thread-action-buttons">
                    ...
                    <button class="btn btn-danger thread-delete-button data-thread-id=${thread._id}"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                        class="bi bi-trash-fill delete-button" viewBox="0 0 16 16">
                        <path
